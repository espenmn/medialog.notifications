...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_notifications_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='notifications-view'
        )
        self.assertTrue(view.__name__ == 'notifications-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in notifications-view'
        # )

    def test_notifications_view_not_matching_interface(self):
